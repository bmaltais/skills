...
from azqt.submission.run import run_submit_tickets
...
def _handle_submit_tickets(args: argparse.Namespace) -> int:
    """Parse arguments, delegate to the submission run, and print its result."""

    _print_json(run_submit_tickets(args.input, args.run))
    return 0
